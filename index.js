...
// }
function getPokemons(key) {
    var getPokemonList = sessionStorage.getItem(key);
    if (getPokemonList !== null) {
        // fetchPokemons();
        console.log("It's not null");
        var pokemon = JSON.parse(getPokemonList);
